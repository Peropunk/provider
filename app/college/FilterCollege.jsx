        ...
        <div className="bg-white/70 backdrop-blur-xl p-6 lg:p-8 rounded-2xl shadow-2xl shadow-slate-900/10 border border-slate-200/80">
          <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-6">
            ...
            <div className="relative w-full lg:col-span-2">
              <select className="appearance-none w-full bg-slate-100 border-2 border-transparent rounded-lg py-3 px-4 text-slate-800 focus:bg-white focus:border-blue-500 focus:outline-none focus:ring-0 transition-all">
                <option className="text-slate-400">Location</option>
            ...
            <div className="relative w-full lg:col-span-2">
              <select className="appearance-none w-full bg-slate-100 border-2 border-transparent rounded-lg py-3 px-4 text-slate-800 focus:bg-white focus:border-blue-500 focus:outline-none focus:ring-0 transition-all">
                <option className="text-slate-400">Courses</option>
            ...
            {/* --- "Clear" Ghost Button --- */}
            <div className="w-full lg:col-span-1 lg:text-center">
              <button
                  type="button"
                  onClick={handleClear}
